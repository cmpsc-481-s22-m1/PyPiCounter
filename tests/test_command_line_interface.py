...
def test_main_imports():
    ...
    import_result = cli_runner.invoke(cli, ["--input-file", "input/sample_file.py", "--import_statements"]) # pylint: disable=C0301
...
def test_main_comment():
    ...
    comment_result = cli_runner.invoke(cli, ["--input-file", "input/sample_file.py", "--comment"]) # pylint: disable=C0301
...
def test_main_function_def():
    ...
    function_def_result = cli_runner.invoke(cli, ["--input-file", "input/sample_file.py", "--function_def"]) # pylint: disable=C0301
...
def test_main_function_without_docstrings():
    ...
    func_wo_docstr_result = cli_runner.invoke(cli, ["--input-file", "input/sample_file.py", "--function_without_docstrings"]) # pylint: disable=C0301
...
def test_main_class_without_docstrings():
    ...
    class_wo_docstr_result = cli_runner.invoke(cli, ["--input-file", "input/sample_file.py", "--class_without_docstrings"]) # pylint: disable=C0301
